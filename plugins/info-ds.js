...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  await conn.sendMessage(m.chat, {text: '♥︎ Iniciando...'}, {quoted: m});
  const sessionPath = './BocchiSession'
  try {
    ...
    if (filesDeleted === 0) {
      ...
      await conn.sendMessage(m.chat, {text: `♥︎ Se eliminaron ${filesDeleted} archivos.`}, {quoted: m});
    }
  } catch {
