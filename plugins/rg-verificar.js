...
let handler = async function (m, { conn, text, args, usedPrefix, command }) {
    ...
    let regbot = `┏━━━━━━━━━━━━━━━━━━⬣
┃⋄ *✦ 𝐑𝐄𝐆𝐈𝐒𝐓𝐑𝐎 - 𝐁𝐎𝐂𝐂𝐇𝐈-𝐖𝐀𝐁𝐎𝐓*
┗━━━━━━━━━━━━━━━━━━⬣\n`
    regbot += `•✩.･*:｡≻──── ⋆♡⋆ ────.•*:｡✩•\n`
    regbot += `*「♥︎」𝐍𝐨𝐦𝐛𝐫𝐞:* ${name}\n`
    regbot += `*「♥︎」𝐄𝐝𝐚𝐝:* ${age} años\n`
    regbot += `•✩.･*:｡≻──── ⋆♡⋆ ────.•*:｡✩•\n`
    regbot += `*「✦」𝐑𝐞𝐜𝐨𝐦𝐩𝐞𝐧𝐬𝐚𝐬:*\n> `
    regbot += `• 15 Estrellas 🌟\n> `
    regbot += `• 5 BocchiCoins 🪙\n> `
    regbot += `• 245 Experiencia 💸\n> `
    regbot += `• 12 Tokens 💰\n`
    regbot += `꒷꒷꒦꒷꒦꒷꒦꒷꒦꒷꒦꒷꒦꒷꒦꒷꒦꒷꒦꒷꒷꒦꒷\n> `
    regbot += `♥︎ Usᥲ *#perfil* ⍴ᥲrᥲ ᥎ᥱr 𝗍ᥙ ⍴ᥱr𝖿іᥣ.`
...
✦ *𝙴𝚍𝚊𝚍* » ${user.age} años
♥︎ *𝙳𝚎𝚜𝚌𝚛𝚒𝚙𝚌𝚒𝚘𝚗* » ${user.descripcion}
✦ *𝙽𝚞𝚖𝚎𝚛𝚘 𝚍𝚎 𝚛𝚎𝚐𝚒𝚜𝚝𝚛𝚘* »
⤷ ${sn}`;

    let channelID = '120363422252549280@newsletter';
